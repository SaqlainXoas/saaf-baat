        ...
        "stories": [
            {
                ...
                "priority": 80,
                "headline": "Fuel subsidy fight moves back to centre-stage",
                "summary": "Officials are weighing fuel subsidy changes under budget pressure. Any move could affect household costs and transport fares quickly.",
                "category": "economy",
                "impact_labels": ["💳 WALLET"],
                "why_it_matters": "Fuel pricing shifts pass through to households and businesses.",
        ...
        "stories": [
            {
                ...
                "summary": "Parsed response should be accepted without reparsing raw text.",
                "category": "economy",
                "impact_labels": ["💳 WALLET"],
                "why_it_matters": "Fuel costs matter to households.",
    ...
    class _GroqStub:
        ...
        def review_clusters(self, candidates, *, max_stories: int = 9):
            return {candidates[0].cluster_id: EditorialStory(**{
                ...
                "summary": "Fallback summary that is long enough to pass validation.",
                "category": "economy",
                "impact_labels": ["💳 WALLET"],
                "why_it_matters": "Matters because it hits wallets.",
